package elevatorsManagement.security;
...
import elevatorsManagement.security.payload.LoginAttempt;
...
public class LoginAttemptService {
    ...
    @Value("${elevatorsManagement.app.max-attempts}")
    private Integer maxAttempt;

    @Value("${elevatorsManagement.app.login-locker-in-min}")
    private Long loginLockerInMin;

    private LoadingCache<String, LoginAttempt> attemptsCache;

    public LoginAttemptService(@Value("${elevatorsManagement.app.login-locker-in-min}") Long loginLockerInMin) {
        super();
